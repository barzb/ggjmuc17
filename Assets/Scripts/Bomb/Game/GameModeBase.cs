...
public class GameModeBase : MonoBehaviour
{
    ...
    public string LoadedLevelName { get { return loadedLevel; } }
    ...
    public virtual void SetupGame(int numPlayers, string loadedLevel)
    {
    ...
    {
        gameInProgress = false;
        debriefMenu.Show(PlayerStatics.Get(playersAlive[0].PlayerId).name + " player won the game");
    }
